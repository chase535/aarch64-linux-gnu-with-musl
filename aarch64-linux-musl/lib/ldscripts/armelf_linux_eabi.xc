...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/home/runner/work/aarch64-linux-musl-gcc/aarch64-linux-musl-gcc/output/toolchain/aarch64-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
